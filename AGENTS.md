...
- Package boundaries are meaningful here: `chat/` owns chat window state + notification behavior, `config/` owns persistence, `mixin/` owns UI injections, `sound/` owns sound registration.
