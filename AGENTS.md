...
- Package boundaries are meaningful here: `chat/` owns chat window state + notification behavior, `config/` owns persistence + the in-game options screen, `mixin/` owns UI injections, `sound/` owns sound registration.
